...
(function () {
  ...
  // ============================================================
  const kit = [
    { icon: '📻', name: 'Радиоприёмник PL-330', note: 'сам приёмник' },
    { icon: '🔋', name: 'Аккумулятор BL-5C', note: 'стоит в отсеке сзади, 3,7 В' },
    ...
    { icon: '📖', name: 'Руководство пользователя', note: 'на русском языке' },
  ...
  // ============================================================
  const parts = [
    { n: 1, id: 'p-ant',   name: 'Телескопическая антенна', text: 'Для FM и коротких волн. Выдвигается и поворачивается.' },
    { n: 2, id: 'p-lcd',   name: 'Дисплей с подсветкой', text: 'Показывает частоту, время, заряд и значки режимов.' },
    { n: 3, id: 'p-fer',   name: 'Ферритовая антенна', text: 'Стержень с катушкой внутри корпуса — ловит средние и длинные волны.' },
    ...
    { n: 6, id: 'p-bat',   name: 'Аккумулятор BL-5C', text: 'В отсеке сзади под крышкой. Съёмный, 3,7 В.' },
